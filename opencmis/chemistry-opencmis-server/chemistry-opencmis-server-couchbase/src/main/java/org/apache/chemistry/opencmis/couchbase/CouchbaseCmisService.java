...
/**
 * Couchbase Service implementation.
 */
public class CouchbaseCmisService extends AbstractCmisService implements CallContextAwareCmisService {
    ...
    public RepositoryInfo getRepositoryInfo(String repositoryId, ExtensionsData extension) {
        for (CouchbaseRepository cbr : repositoryManager.getRepositories()) {
            if (cbr.getRepositoryId().equals(repositoryId)) {
                return cbr.getRepositoryInfo(getCallContext());
            }
        }

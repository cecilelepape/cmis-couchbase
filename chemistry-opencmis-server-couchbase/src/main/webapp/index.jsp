...
<%@ page import="org.apache.chemistry.opencmis.couchbase.*" %>
<%@ page import="org.apache.chemistry.opencmis.commons.definitions.*" %>
<%
   CouchbaseCmisServiceFactory factory = (CouchbaseCmisServiceFactory) application.getAttribute("org.apache.chemistry.opencmis.servicesfactory");
%>
...
<% for (CouchbaseRepository fsr: factory.getRepositoryManager().getRepositories()) { %>

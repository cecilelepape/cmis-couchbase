 ...
 */
public class CouchbaseCmisService extends AbstractCmisService implements CallContextAwareCmisService {

	private static final Logger LOG = LoggerFactory
			.getLogger(CouchbaseCmisService.class);
	
    private final CouchbaseRepositoryManager repositoryManager;
    private CallContext context;

    public CouchbaseCmisService(final CouchbaseRepositoryManager repositoryManager) {
    ...
    public void setCallContext(CallContext context) {
        ...
        /*debug("binding:"+context.getBinding());
        debug("password:"+context.getPassword());
        debug("locale:"+context.getLocale());
        debug("maxcontentsize:"+context.getMaxContentSize());
        debug("memorythreshold:"+context.getMemoryThreshold());
        debug("repoid:"+context.getRepositoryId());
        debug("username:"+context.getUsername());
        debug("toString:"+context.toString());
        debug("tempDirectory:"+context.getTempDirectory().getAbsolutePath());
        debug("offset:"+context.getOffset());
        debug("offset:"+context.getOffset());
        debug("length:"+context.getLength());
        debug("length:"+context.getLength());
        debug("cmisversion"+context.getCmisVersion());
        debug("cmisversion"+context.getCmisVersion());
        debug("encrypTempFile"+context.encryptTempFiles());
        debug("isObjectInfoRequired"+context.isObjectInfoRequired());*/
    }
    ...
    public ObjectInFolderList getChildren(String repositoryId, String folderId, String filter, String orderBy,
    	...
    	System.out.println("CouchbaseCmisService getChildren folderId:"+folderId);
